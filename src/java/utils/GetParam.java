...
public class GetParam {
    ...
    public static String getEmail(String value) {
        ...
        Pattern regex = Pattern.compile("\\b[\\w.%-]+@fpt.edu.vn\\b");

        boolean isMatched = regex.matcher(value).matches();
        if (!isMatched) {
            return " is not correct format. Please enter a valid email with domain @fpt.edu.vn";
        }
    ...
    public static String getEmailParams(HttpServletRequest request, String field, String label) {
        ...
        String errorMessage = getEmail(value);
